# Example of a one-dimensional array (list in Python) / Exemplo de um array unidimensional (lista em Python) / Ejemplo de un array unidimensional (lista en Python)
arr = [1, 2, 3, 4, 5]
...
# Modifying elements / Modificando elementos
arr[1] = 10
...
# Checking if an element is in the array / Verificando se um elemento está no array / Verificando si un elemento está en el array
print(3 in arr) # Output / Saída / Salida: True

# Finding the length of the array / Encontrando o tamanho do array / Encontrando el tamaño del array
print(len(arr)) # Output / Saída / Salida: 5

# Finding the index of an element / Encontrando o índice de um elemento / Encontrando el índice de un elemento
